...
class DebugEngine {
  constructor(worker) {
    if (!worker) {
      const workerBlob = new Blob([`importScripts("https://unpkg.com/css-to-js-sourcemap-worker@2.0.4/worker.js")`], {
...
`);
      ...
      const style = resolveStyle(getInitialStyle$$1, reducers, props);
